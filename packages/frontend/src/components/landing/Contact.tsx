...
export const Contact: React.FC = () => {
    ...
    return (
        <ScrollReveal animation="fade-in">
            <section id="contact-section" className="max-w-4xl mx-auto mb-14 sm:mb-20 px-4 sm:px-6">
                ...
                {loading ? (
                    ...
                    <div className="card bg-slate-800/40 backdrop-blur-md p-6 sm:p-10 rounded-2xl border-t border-r border-b border-slate-700/50 border-l-4 border-l-accent shadow-2xl">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                            {contactInfo.email && (
                                <div className="flex flex-col items-center text-center p-6 bg-slate-900/50 rounded-2xl border border-gray-700/50 hover:border-accent transition-all duration-300 hover-lift">
                                    ...
                                    <a
                                        ...
                                        className="text-slate-300 hover:text-accent transition-colors break-all"
                                    >
                                        {contactInfo.email}
                                    </a>
                                </div>
