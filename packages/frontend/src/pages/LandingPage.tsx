...
export const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-transparent text-white font-sans">
            ...
            {/* Header/Nav */}
            <header className="sticky top-0 z-20 glass-strong border-b border-gray-700/50">
                <div className="max-w-7xl mx-auto flex justify-between items-center py-3 sm:py-4 px-4 sm:px-6">
                    <div className="text-xl sm:text-2xl font-black gradient-text-primary">Cloud Capital</div>
                    ...
                    <button
                        ...
                        className="btn btn-primary py-2 px-4 sm:px-6 text-sm font-bold"
                    >
                        Acceder / Registro
                    </button>
                </div>
            ...
            <section id="plans-section" className="max-w-6xl mx-auto mb-16 sm:mb-28 px-4 sm:px-6">
                ...
                <p className="text-center text-gray-400 text-sm sm:text-lg mb-8 sm:mb-12 max-w-2xl mx-auto">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
                        {plans.map((plan) => (
                            <div
                                key={plan.id}
                                className="card p-5 sm:p-6 rounded-2xl border-l-4 border-accent hover:border-l-[6px] hover-lift group transition-all duration-300"
                            >
            ...
            {/* CTA Section */}
            <section className="max-w-4xl mx-auto text-center glass p-6 sm:p-12 rounded-3xl shadow-2xl border border-gray-700/50 mb-12 sm:mb-20 mx-4">
                <h3 className="text-3xl sm:text-4xl font-black mb-3 sm:mb-4 gradient-text-primary">
                    Inicia tu inversión hoy
                </h3>
                <p className="text-sm sm:text-lg text-gray-400 mb-6 sm:mb-8 max-w-xl mx-auto">
            ...
            {/* Footer */}
            <footer className="text-center text-xs text-gray-500 py-8 border-t border-gray-700/50 max-w-7xl mx-auto px-4 sm:px-6">
